...
public class TabulationBestSumTest {
	
	@Rule
	public Timeout globalTimeout = Timeout.seconds(1);
	
	public static final Object[] getTestData() {
		return new Object[] { new Object[] { 8, new int[] { 3, 5, 7, 8 }, Arrays.asList(8) },
	...
	public void shouldComputeCorrect(int num, int[] values, List<Integer> expected) {
		List<Integer> result =  TabulationBestSum.compute(num, values);
